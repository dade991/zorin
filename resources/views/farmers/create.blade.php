<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Add Farmer</h2>
    </x-slot>
            ...
            <form method="POST" action="{{ route('farmers.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="address" rows="3"
                              class="w-full border-gray-300 rounded shadow-sm focus:ring-green-500 focus:border-green-500">{{ old('address') }}</textarea>
                </div>
